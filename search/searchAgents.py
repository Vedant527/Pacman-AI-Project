...
def cornersHeuristic(state, problem):
    ...
    while len(unvisited) > 0:
        comp = abs(unvisited[0][0] - current[0]) + abs(unvisited[0][1] - current[1])
        minimum = unvisited[0]
        for corner in unvisited:
            ...
            if dist <= comp:
                ...
                minimum = corner
        distance += comp
        unvisited = unvisited[:unvisited.index(minimum)] + unvisited[unvisited.index(minimum) + 1:]
        current = minimum
